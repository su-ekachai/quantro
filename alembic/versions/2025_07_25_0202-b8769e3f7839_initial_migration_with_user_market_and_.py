"""Initial migration with user, market, and trading models

Revision ID: b8769e3f7839
Revises:
Create Date: 2025-07-25 02:02:37.789663
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "symbol_id", "timestamp", "timeframe", name="uq_market_data"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        "idx_market_data_timeframe", "market_data", ["timeframe"], unique=False
    )
    ...
    op.create_index(
        "idx_signals_generated_at", "trading_signals", ["generated_at"], unique=False
    )
    op.create_index("idx_signals_status", "trading_signals", ["status"], unique=False)
    op.create_index(
        "idx_signals_strategy_symbol",
        "trading_signals",
